   ...
   <div className={style.footer_main}>
     <div className={style.footer_main_1}>
       <div className={style.footer_main_part1}>
         ...
         <a href="/" className={style.footer_main_part1_2}>Get started</a>
         </div>
       </div>
