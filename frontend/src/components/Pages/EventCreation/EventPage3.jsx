    ...
    return (
        ...
        <div>
            ...
            <div style={{ width: "100%", display: "flex" }}>
                <div style={{ backgroundColor: "rgb(0, 130, 148) ", width: "36%", height: "15px" }} ></div>
                <div style={{ backgroundColor: "lightgrey ", width: "64%", height: "15px" }} ></div>
            </div>
            <div className={styles.eve1} >
                ...
                <h1><input style={{ width: "67%", height: "50px", textAlign: "center", fontSize: "20px" }} /* value={header} */ placeholder="Enter Group Name"
                    /* onChange={(e) => setHeader(e.target.value)} */ /></h1>
            </div>
            <div className={styles.eve3_button}>
                <Link to="/start/topics" ><button className={styles.eve3_back} >Back</button></Link>
                <Link to="/start/description" ><button className={styles.eve2_next}>Next</button></Link>
            </div>
        </div>
    )
}
