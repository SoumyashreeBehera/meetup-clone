  ...
  return (
    <div>
      ...
      <div style={{ width: '100%', display: 'flex' }}>
        ...
        ></div>
        <div style={{ width: '30%',backgroundColor: 'lightgrey ', height: '15px' }}></div>
      </div>
      <div className={styles.eve1}>
        ...
        <br />
        <div style={{ textAlign: 'left', margin: '1px', width: '700px', height: "100px"}}>
      ...
      <div className={styles.eve2_button}>
        <Link to="/start/description" ><button className={styles.eve2_back}>Back</button></Link>
